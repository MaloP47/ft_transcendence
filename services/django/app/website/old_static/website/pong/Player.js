...
export default class Player {
	...
	updateRemote() {
		//console.log('level 3: Player.js');
		//console.log(this.pong.rd);
		if (this.player == 1) {
			this.bar.position.x = this.pong.rd.p1pos.x;
			this.bar.position.y = this.pong.rd.p1pos.y;
		}
		else {
			this.bar.position.x = this.pong.rd.p2pos.x;
			this.bar.position.y = this.pong.rd.p2pos.y;
		}
		this.prevPos = this.currentPos.clone();
		this.currentPos = this.bar.position.clone();
	}
