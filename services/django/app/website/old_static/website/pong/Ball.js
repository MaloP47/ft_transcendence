...
export default class Ball {
	...
	updateRemote() {
		//console.log('level 3: Ball.js');
		//console.log(this.pong.rd);
		this.velocity.x = this.pong.rd.ballvel.x;
		this.velocity.y = this.pong.rd.ballvel.y;
		this.ball.position.x = this.pong.rd.ballpos.x;
		this.ball.position.y = this.pong.rd.ballpos.y;
		this.prevPos = this.currentPos.clone();
		this.currentPos = this.ball.position.clone();
	}
